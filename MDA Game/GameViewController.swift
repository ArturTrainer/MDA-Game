...
//  MDA Game
//
//  Created by Artur Akhmetshin on 23.09.2020.
//
...
class GameViewController: UIViewController {
    ...
    func spawnShip () {
        ...
        //Position the ship
        let x = Int.random(in: -35...35)
        let y = Int.random(in: -35...35)
        let z = -105
        ship.position = SCNVector3(x, y, z)
        
        //Set direction vector of object - to camera
        ship.look(at: SCNVector3(3 * x,3 * y,3 * z))
